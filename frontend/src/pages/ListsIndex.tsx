    ...
    return (
      <div className="container">
        <Card>
          ...
          <Button onClick={() => navigate('/app')} icon={<ArrowLeft />}>Back to House</Button>
        </Card>
      </div>
    )
  }
          ...
          {lists.length === 0 ? (
            ...
            <AntList
              ...
              renderItem={(l) => (
                <AntList.Item
                  actions={[
                    <Button key="open" type="primary" onClick={() => navigate(`/app/lists/${l.list_id}`)} icon={<FolderOpen />}>Open</Button>,
                  ]}
                >
                  <AntList.Item.Meta
